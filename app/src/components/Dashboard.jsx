    ...
    <div className="container mx-auto px-12 py-24">
      ...
      <div className="flex flex-col mt-8">
        <div className="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
          <div
            className="flex flex-col gap-6 min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200 text-gray-700 p-4 ">
            ...
            <Plot
              ...
              layout={{ width: 520, height: 440, title: `My Cool Graph`, xaxis: {fixedrange: true} }}
            />
            </div>
          </div>
        </div>
